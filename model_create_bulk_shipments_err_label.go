...
// CreateBulkShipmentsERRLabel ShipmentBatch information contains following schema
type CreateBulkShipmentsERRLabel struct {
	...
	// Default `parcelType` specific to the carrier, e.g., PKG, SOFTPACK to be used for this batch. You can override this value by defining it at shipment level.

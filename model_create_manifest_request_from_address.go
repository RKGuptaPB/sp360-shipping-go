...
// checks if the CreateManifestRequestFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateManifestRequestFromAddress{}

// CreateManifestRequestFromAddress struct for CreateManifestRequestFromAddress
type CreateManifestRequestFromAddress struct {
...
type _CreateManifestRequestFromAddress CreateManifestRequestFromAddress
...
func NewCreateManifestRequestFromAddress(addressLine1 string, countryCode string, postalCode string) *CreateManifestRequestFromAddress {
	this := CreateManifestRequestFromAddress{}
...
func (o CreateManifestRequestFromAddress) MarshalJSON() ([]byte, error) {
...
func (o CreateManifestRequestFromAddress) ToMap() (map[string]interface{}, error) {
...
func (o *CreateManifestRequestFromAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateManifestRequestFromAddress := _CreateManifestRequestFromAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateManifestRequestFromAddress)

	if err != nil {
		return err
	}

	*o = CreateManifestRequestFromAddress(varCreateManifestRequestFromAddress)

	return err
}

type NullableCreateManifestRequestFromAddress struct {
	value *CreateManifestRequestFromAddress
	isSet bool
}

func (v NullableCreateManifestRequestFromAddress) Get() *CreateManifestRequestFromAddress {
	return v.value
}

func (v *NullableCreateManifestRequestFromAddress) Set(val *CreateManifestRequestFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateManifestRequestFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateManifestRequestFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateManifestRequestFromAddress(val *CreateManifestRequestFromAddress) *NullableCreateManifestRequestFromAddress {
	return &NullableCreateManifestRequestFromAddress{value: val, isSet: true}
}

func (v NullableCreateManifestRequestFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateManifestRequestFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

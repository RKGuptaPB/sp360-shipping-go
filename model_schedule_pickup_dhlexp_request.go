...
// checks if the SchedulePickupDHLEXPRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchedulePickupDHLEXPRequest{}

// SchedulePickupDHLEXPRequest struct for SchedulePickupDHLEXPRequest
type SchedulePickupDHLEXPRequest struct {
	// description
...
func NewSchedulePickupDHLEXPRequest() *SchedulePickupDHLEXPRequest {
	this := SchedulePickupDHLEXPRequest{}
	return &this
}
...
func (o SchedulePickupDHLEXPRequest) MarshalJSON() ([]byte, error) {
...
func (o SchedulePickupDHLEXPRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSchedulePickupDHLEXPRequest struct {
	value *SchedulePickupDHLEXPRequest
	isSet bool
}

func (v NullableSchedulePickupDHLEXPRequest) Get() *SchedulePickupDHLEXPRequest {
	return v.value
}

func (v *NullableSchedulePickupDHLEXPRequest) Set(val *SchedulePickupDHLEXPRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedulePickupDHLEXPRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedulePickupDHLEXPRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedulePickupDHLEXPRequest(val *SchedulePickupDHLEXPRequest) *NullableSchedulePickupDHLEXPRequest {
	return &NullableSchedulePickupDHLEXPRequest{value: val, isSet: true}
}

func (v NullableSchedulePickupDHLEXPRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedulePickupDHLEXPRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

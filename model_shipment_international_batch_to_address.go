...
// checks if the ShipmentInternationalBatchToAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipmentInternationalBatchToAddress{}

// ShipmentInternationalBatchToAddress struct for ShipmentInternationalBatchToAddress
type ShipmentInternationalBatchToAddress struct {
...
type _ShipmentInternationalBatchToAddress ShipmentInternationalBatchToAddress
...
func NewShipmentInternationalBatchToAddress(addressLine1 string, countryCode string, postalCode string, stateProvince string) *ShipmentInternationalBatchToAddress {
	this := ShipmentInternationalBatchToAddress{}
...
func (o ShipmentInternationalBatchToAddress) MarshalJSON() ([]byte, error) {
...
func (o ShipmentInternationalBatchToAddress) ToMap() (map[string]interface{}, error) {
...
func (o *ShipmentInternationalBatchToAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varShipmentInternationalBatchToAddress := _ShipmentInternationalBatchToAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShipmentInternationalBatchToAddress)

	if err != nil {
		return err
	}

	*o = ShipmentInternationalBatchToAddress(varShipmentInternationalBatchToAddress)

	return err
}

type NullableShipmentInternationalBatchToAddress struct {
	value *ShipmentInternationalBatchToAddress
	isSet bool
}

func (v NullableShipmentInternationalBatchToAddress) Get() *ShipmentInternationalBatchToAddress {
	return v.value
}

func (v *NullableShipmentInternationalBatchToAddress) Set(val *ShipmentInternationalBatchToAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableShipmentInternationalBatchToAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableShipmentInternationalBatchToAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipmentInternationalBatchToAddress(val *ShipmentInternationalBatchToAddress) *NullableShipmentInternationalBatchToAddress {
	return &NullableShipmentInternationalBatchToAddress{value: val, isSet: true}
}

func (v NullableShipmentInternationalBatchToAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipmentInternationalBatchToAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

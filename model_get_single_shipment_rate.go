...
// checks if the GetSingleShipmentRate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSingleShipmentRate{}

// GetSingleShipmentRate struct for GetSingleShipmentRate
type GetSingleShipmentRate struct {
	...
	SpecialServices []GetSingleShipmentRateSpecialServicesInner `json:"specialServices,omitempty"`
...
func (o *GetSingleShipmentRate) GetSpecialServices() []GetSingleShipmentRateSpecialServicesInner {
	if o == nil || IsNil(o.SpecialServices) {
		var ret []GetSingleShipmentRateSpecialServicesInner
		return ret
	}
...
// SetSpecialServices gets a reference to the given []GetSingleShipmentRateSpecialServicesInner and assigns it to the SpecialServices field.
...
func (o GetSingleShipmentRate) MarshalJSON() ([]byte, error) {
...
func (o GetSingleShipmentRate) ToMap() (map[string]interface{}, error) {
...
type NullableGetSingleShipmentRate struct {
	value *GetSingleShipmentRate
	isSet bool
}

func (v NullableGetSingleShipmentRate) Get() *GetSingleShipmentRate {
	return v.value
}

func (v *NullableGetSingleShipmentRate) Set(val *GetSingleShipmentRate) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSingleShipmentRate) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSingleShipmentRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSingleShipmentRate(val *GetSingleShipmentRate) *NullableGetSingleShipmentRate {
	return &NullableGetSingleShipmentRate{value: val, isSet: true}
}

func (v NullableGetSingleShipmentRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSingleShipmentRate) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ShipmentFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipmentFromAddress{}

// ShipmentFromAddress struct for ShipmentFromAddress
type ShipmentFromAddress struct {
...
type _ShipmentFromAddress ShipmentFromAddress
...
func (o ShipmentFromAddress) MarshalJSON() ([]byte, error) {
...
func (o ShipmentFromAddress) ToMap() (map[string]interface{}, error) {
...
func (o *ShipmentFromAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varShipmentFromAddress := _ShipmentFromAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShipmentFromAddress)

	if err != nil {
		return err
	}

	*o = ShipmentFromAddress(varShipmentFromAddress)

	return err
}

type NullableShipmentFromAddress struct {
	value *ShipmentFromAddress
	isSet bool
}

func (v NullableShipmentFromAddress) Get() *ShipmentFromAddress {
	return v.value
}

func (v *NullableShipmentFromAddress) Set(val *ShipmentFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableShipmentFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableShipmentFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipmentFromAddress(val *ShipmentFromAddress) *NullableShipmentFromAddress {
	return &NullableShipmentFromAddress{value: val, isSet: true}
}

func (v NullableShipmentFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipmentFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

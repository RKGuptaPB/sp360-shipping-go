...
// checks if the AddressSuggestResponseSuggestionsAddressesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressSuggestResponseSuggestionsAddressesInner{}

// AddressSuggestResponseSuggestionsAddressesInner struct for AddressSuggestResponseSuggestionsAddressesInner
type AddressSuggestResponseSuggestionsAddressesInner struct {
...
func NewAddressSuggestResponseSuggestionsAddressesInner() *AddressSuggestResponseSuggestionsAddressesInner {
	this := AddressSuggestResponseSuggestionsAddressesInner{}
	return &this
}
...
func (o AddressSuggestResponseSuggestionsAddressesInner) MarshalJSON() ([]byte, error) {
...
func (o AddressSuggestResponseSuggestionsAddressesInner) ToMap() (map[string]interface{}, error) {
...
type NullableAddressSuggestResponseSuggestionsAddressesInner struct {
	value *AddressSuggestResponseSuggestionsAddressesInner
	isSet bool
}

func (v NullableAddressSuggestResponseSuggestionsAddressesInner) Get() *AddressSuggestResponseSuggestionsAddressesInner {
	return v.value
}

func (v *NullableAddressSuggestResponseSuggestionsAddressesInner) Set(val *AddressSuggestResponseSuggestionsAddressesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressSuggestResponseSuggestionsAddressesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressSuggestResponseSuggestionsAddressesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressSuggestResponseSuggestionsAddressesInner(val *AddressSuggestResponseSuggestionsAddressesInner) *NullableAddressSuggestResponseSuggestionsAddressesInner {
	return &NullableAddressSuggestResponseSuggestionsAddressesInner{value: val, isSet: true}
}

func (v NullableAddressSuggestResponseSuggestionsAddressesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressSuggestResponseSuggestionsAddressesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true

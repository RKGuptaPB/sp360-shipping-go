...
// checks if the GetSingleShipmentFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSingleShipmentFromAddress{}

// GetSingleShipmentFromAddress struct for GetSingleShipmentFromAddress
type GetSingleShipmentFromAddress struct {
...
func NewGetSingleShipmentFromAddress() *GetSingleShipmentFromAddress {
	this := GetSingleShipmentFromAddress{}
	return &this
}
...
func (o GetSingleShipmentFromAddress) MarshalJSON() ([]byte, error) {
...
func (o GetSingleShipmentFromAddress) ToMap() (map[string]interface{}, error) {
...
type NullableGetSingleShipmentFromAddress struct {
	value *GetSingleShipmentFromAddress
	isSet bool
}

func (v NullableGetSingleShipmentFromAddress) Get() *GetSingleShipmentFromAddress {
	return v.value
}

func (v *NullableGetSingleShipmentFromAddress) Set(val *GetSingleShipmentFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSingleShipmentFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSingleShipmentFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSingleShipmentFromAddress(val *GetSingleShipmentFromAddress) *NullableGetSingleShipmentFromAddress {
	return &NullableGetSingleShipmentFromAddress{value: val, isSet: true}
}

func (v NullableGetSingleShipmentFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSingleShipmentFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ParcelTypesInnerBrandedDimensions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParcelTypesInnerBrandedDimensions{}

// ParcelTypesInnerBrandedDimensions This will be available for parcels with Parcel Type as branded.
type ParcelTypesInnerBrandedDimensions struct {
	// This is the measure around parcel by area or circumference.
	Girth *float32 `json:"girth,omitempty"`
...
func NewParcelTypesInnerBrandedDimensions() *ParcelTypesInnerBrandedDimensions {
	this := ParcelTypesInnerBrandedDimensions{}
	return &this
}
...
// GetGirth returns the Girth field value if set, zero value otherwise.
func (o *ParcelTypesInnerBrandedDimensions) GetGirth() float32 {
	if o == nil || IsNil(o.Girth) {
		var ret float32
		return ret
	}
	return *o.Girth
...
// GetGirthOk returns a tuple with the Girth field value if set, nil otherwise
...
// SetGirth gets a reference to the given float32 and assigns it to the Girth field.
...
func (o ParcelTypesInnerBrandedDimensions) MarshalJSON() ([]byte, error) {
...
func (o ParcelTypesInnerBrandedDimensions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Girth) {
		toSerialize["girth"] = o.Girth
	}
	if !IsNil(o.Length) {
...
type NullableParcelTypesInnerBrandedDimensions struct {
	value *ParcelTypesInnerBrandedDimensions
	isSet bool
}

func (v NullableParcelTypesInnerBrandedDimensions) Get() *ParcelTypesInnerBrandedDimensions {
	return v.value
}

func (v *NullableParcelTypesInnerBrandedDimensions) Set(val *ParcelTypesInnerBrandedDimensions) {
	v.value = val
	v.isSet = true
}

func (v NullableParcelTypesInnerBrandedDimensions) IsSet() bool {
	return v.isSet
}

func (v *NullableParcelTypesInnerBrandedDimensions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParcelTypesInnerBrandedDimensions(val *ParcelTypesInnerBrandedDimensions) *NullableParcelTypesInnerBrandedDimensions {
	return &NullableParcelTypesInnerBrandedDimensions{value: val, isSet: true}
}

func (v NullableParcelTypesInnerBrandedDimensions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParcelTypesInnerBrandedDimensions) UnmarshalJSON(src []byte) error {
	v.isSet = true

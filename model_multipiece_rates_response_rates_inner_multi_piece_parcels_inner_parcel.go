...
// checks if the MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel{}

// MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel description
type MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel struct {
	// description
...
func NewMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel() *MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel {
	this := MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel{}
	return &this
}
...
func (o *MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) HasWeightUnit() bool {
	if o != nil && !IsNil(o.WeightUnit) {
		return true
	}
...
func (o MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) MarshalJSON() ([]byte, error) {
...
func (o MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) ToMap() (map[string]interface{}, error) {
...
type NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel struct {
	value *MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel
	isSet bool
}

func (v NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) Get() *MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel {
	return v.value
}

func (v *NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) Set(val *MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel(val *MultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) *NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel {
	return &NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel{value: val, isSet: true}
}

func (v NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultipieceRatesResponseRatesInnerMultiPieceParcelsInnerParcel) UnmarshalJSON(src []byte) error {
	v.isSet = true

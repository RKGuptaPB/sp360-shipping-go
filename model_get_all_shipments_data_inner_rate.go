...
// checks if the GetAllShipmentsDataInnerRate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllShipmentsDataInnerRate{}

// GetAllShipmentsDataInnerRate struct for GetAllShipmentsDataInnerRate
type GetAllShipmentsDataInnerRate struct {
	...
	SpecialServices []GetAllShipmentsDataInnerRateSpecialServicesInner `json:"specialServices,omitempty"`
...
func NewGetAllShipmentsDataInnerRate() *GetAllShipmentsDataInnerRate {
	this := GetAllShipmentsDataInnerRate{}
	return &this
}
...
func (o *GetAllShipmentsDataInnerRate) GetSpecialServices() []GetAllShipmentsDataInnerRateSpecialServicesInner {
	if o == nil || IsNil(o.SpecialServices) {
		var ret []GetAllShipmentsDataInnerRateSpecialServicesInner
		return ret
	}
...
// SetSpecialServices gets a reference to the given []GetAllShipmentsDataInnerRateSpecialServicesInner and assigns it to the SpecialServices field.
...
func (o GetAllShipmentsDataInnerRate) MarshalJSON() ([]byte, error) {
...
func (o GetAllShipmentsDataInnerRate) ToMap() (map[string]interface{}, error) {
...
type NullableGetAllShipmentsDataInnerRate struct {
	value *GetAllShipmentsDataInnerRate
	isSet bool
}

func (v NullableGetAllShipmentsDataInnerRate) Get() *GetAllShipmentsDataInnerRate {
	return v.value
}

func (v *NullableGetAllShipmentsDataInnerRate) Set(val *GetAllShipmentsDataInnerRate) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllShipmentsDataInnerRate) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllShipmentsDataInnerRate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllShipmentsDataInnerRate(val *GetAllShipmentsDataInnerRate) *NullableGetAllShipmentsDataInnerRate {
	return &NullableGetAllShipmentsDataInnerRate{value: val, isSet: true}
}

func (v NullableGetAllShipmentsDataInnerRate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllShipmentsDataInnerRate) UnmarshalJSON(src []byte) error {
	v.isSet = true

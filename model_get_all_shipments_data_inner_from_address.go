...
// checks if the GetAllShipmentsDataInnerFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAllShipmentsDataInnerFromAddress{}

// GetAllShipmentsDataInnerFromAddress struct for GetAllShipmentsDataInnerFromAddress
type GetAllShipmentsDataInnerFromAddress struct {
...
func NewGetAllShipmentsDataInnerFromAddress() *GetAllShipmentsDataInnerFromAddress {
	this := GetAllShipmentsDataInnerFromAddress{}
	return &this
}
...
func (o GetAllShipmentsDataInnerFromAddress) MarshalJSON() ([]byte, error) {
...
func (o GetAllShipmentsDataInnerFromAddress) ToMap() (map[string]interface{}, error) {
...
type NullableGetAllShipmentsDataInnerFromAddress struct {
	value *GetAllShipmentsDataInnerFromAddress
	isSet bool
}

func (v NullableGetAllShipmentsDataInnerFromAddress) Get() *GetAllShipmentsDataInnerFromAddress {
	return v.value
}

func (v *NullableGetAllShipmentsDataInnerFromAddress) Set(val *GetAllShipmentsDataInnerFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAllShipmentsDataInnerFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAllShipmentsDataInnerFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAllShipmentsDataInnerFromAddress(val *GetAllShipmentsDataInnerFromAddress) *NullableGetAllShipmentsDataInnerFromAddress {
	return &NullableGetAllShipmentsDataInnerFromAddress{value: val, isSet: true}
}

func (v NullableGetAllShipmentsDataInnerFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAllShipmentsDataInnerFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

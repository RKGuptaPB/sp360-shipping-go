...
// checks if the RateShopResponseToAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RateShopResponseToAddress{}

// RateShopResponseToAddress Recipient address details
type RateShopResponseToAddress struct {
...
func NewRateShopResponseToAddress() *RateShopResponseToAddress {
	this := RateShopResponseToAddress{}
	return &this
}
...
func (o RateShopResponseToAddress) MarshalJSON() ([]byte, error) {
...
func (o RateShopResponseToAddress) ToMap() (map[string]interface{}, error) {
...
type NullableRateShopResponseToAddress struct {
	value *RateShopResponseToAddress
	isSet bool
}

func (v NullableRateShopResponseToAddress) Get() *RateShopResponseToAddress {
	return v.value
}

func (v *NullableRateShopResponseToAddress) Set(val *RateShopResponseToAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableRateShopResponseToAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableRateShopResponseToAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRateShopResponseToAddress(val *RateShopResponseToAddress) *NullableRateShopResponseToAddress {
	return &NullableRateShopResponseToAddress{value: val, isSet: true}
}

func (v NullableRateShopResponseToAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRateShopResponseToAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

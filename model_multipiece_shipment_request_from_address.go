...
// checks if the MultipieceShipmentRequestFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipieceShipmentRequestFromAddress{}

// MultipieceShipmentRequestFromAddress struct for MultipieceShipmentRequestFromAddress
type MultipieceShipmentRequestFromAddress struct {
...
type _MultipieceShipmentRequestFromAddress MultipieceShipmentRequestFromAddress
...
func NewMultipieceShipmentRequestFromAddress(addressLine1 string, countryCode string, postalCode string, stateProvince string) *MultipieceShipmentRequestFromAddress {
	this := MultipieceShipmentRequestFromAddress{}
...
func (o MultipieceShipmentRequestFromAddress) MarshalJSON() ([]byte, error) {
...
func (o MultipieceShipmentRequestFromAddress) ToMap() (map[string]interface{}, error) {
...
func (o *MultipieceShipmentRequestFromAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varMultipieceShipmentRequestFromAddress := _MultipieceShipmentRequestFromAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultipieceShipmentRequestFromAddress)

	if err != nil {
		return err
	}

	*o = MultipieceShipmentRequestFromAddress(varMultipieceShipmentRequestFromAddress)

	return err
}

type NullableMultipieceShipmentRequestFromAddress struct {
	value *MultipieceShipmentRequestFromAddress
	isSet bool
}

func (v NullableMultipieceShipmentRequestFromAddress) Get() *MultipieceShipmentRequestFromAddress {
	return v.value
}

func (v *NullableMultipieceShipmentRequestFromAddress) Set(val *MultipieceShipmentRequestFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipieceShipmentRequestFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipieceShipmentRequestFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipieceShipmentRequestFromAddress(val *MultipieceShipmentRequestFromAddress) *NullableMultipieceShipmentRequestFromAddress {
	return &NullableMultipieceShipmentRequestFromAddress{value: val, isSet: true}
}

func (v NullableMultipieceShipmentRequestFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultipieceShipmentRequestFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

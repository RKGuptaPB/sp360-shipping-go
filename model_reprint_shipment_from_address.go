...
// checks if the ReprintShipmentFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReprintShipmentFromAddress{}

// ReprintShipmentFromAddress struct for ReprintShipmentFromAddress
type ReprintShipmentFromAddress struct {
...
func NewReprintShipmentFromAddress() *ReprintShipmentFromAddress {
	this := ReprintShipmentFromAddress{}
	return &this
}
...
func (o ReprintShipmentFromAddress) MarshalJSON() ([]byte, error) {
...
func (o ReprintShipmentFromAddress) ToMap() (map[string]interface{}, error) {
...
type NullableReprintShipmentFromAddress struct {
	value *ReprintShipmentFromAddress
	isSet bool
}

func (v NullableReprintShipmentFromAddress) Get() *ReprintShipmentFromAddress {
	return v.value
}

func (v *NullableReprintShipmentFromAddress) Set(val *ReprintShipmentFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableReprintShipmentFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableReprintShipmentFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReprintShipmentFromAddress(val *ReprintShipmentFromAddress) *NullableReprintShipmentFromAddress {
	return &NullableReprintShipmentFromAddress{value: val, isSet: true}
}

func (v NullableReprintShipmentFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReprintShipmentFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

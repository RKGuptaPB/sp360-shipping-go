...
// checks if the GetSingleShipmentToAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSingleShipmentToAddress{}

// GetSingleShipmentToAddress struct for GetSingleShipmentToAddress
type GetSingleShipmentToAddress struct {
...
func NewGetSingleShipmentToAddress() *GetSingleShipmentToAddress {
	this := GetSingleShipmentToAddress{}
	return &this
}
...
func (o GetSingleShipmentToAddress) MarshalJSON() ([]byte, error) {
...
func (o GetSingleShipmentToAddress) ToMap() (map[string]interface{}, error) {
...
type NullableGetSingleShipmentToAddress struct {
	value *GetSingleShipmentToAddress
	isSet bool
}

func (v NullableGetSingleShipmentToAddress) Get() *GetSingleShipmentToAddress {
	return v.value
}

func (v *NullableGetSingleShipmentToAddress) Set(val *GetSingleShipmentToAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSingleShipmentToAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSingleShipmentToAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSingleShipmentToAddress(val *GetSingleShipmentToAddress) *NullableGetSingleShipmentToAddress {
	return &NullableGetSingleShipmentToAddress{value: val, isSet: true}
}

func (v NullableGetSingleShipmentToAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSingleShipmentToAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

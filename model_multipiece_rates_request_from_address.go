...
// checks if the MultipieceRatesRequestFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipieceRatesRequestFromAddress{}

// MultipieceRatesRequestFromAddress description
type MultipieceRatesRequestFromAddress struct {
	// description
...
func NewMultipieceRatesRequestFromAddress() *MultipieceRatesRequestFromAddress {
	this := MultipieceRatesRequestFromAddress{}
	return &this
}
...
func (o *MultipieceRatesRequestFromAddress) SetAddressLine1(v string) {
	o.AddressLine1 = &v
}
...
func (o *MultipieceRatesRequestFromAddress) HasStateProvince() bool {
	if o != nil && !IsNil(o.StateProvince) {
		return true
	}
...
func (o MultipieceRatesRequestFromAddress) MarshalJSON() ([]byte, error) {
...
func (o MultipieceRatesRequestFromAddress) ToMap() (map[string]interface{}, error) {
...
type NullableMultipieceRatesRequestFromAddress struct {
	value *MultipieceRatesRequestFromAddress
	isSet bool
}

func (v NullableMultipieceRatesRequestFromAddress) Get() *MultipieceRatesRequestFromAddress {
	return v.value
}

func (v *NullableMultipieceRatesRequestFromAddress) Set(val *MultipieceRatesRequestFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipieceRatesRequestFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipieceRatesRequestFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipieceRatesRequestFromAddress(val *MultipieceRatesRequestFromAddress) *NullableMultipieceRatesRequestFromAddress {
	return &NullableMultipieceRatesRequestFromAddress{value: val, isSet: true}
}

func (v NullableMultipieceRatesRequestFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultipieceRatesRequestFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

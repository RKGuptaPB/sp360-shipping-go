...
// checks if the DomesticShipmentResponseFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomesticShipmentResponseFromAddress{}

// DomesticShipmentResponseFromAddress struct for DomesticShipmentResponseFromAddress
type DomesticShipmentResponseFromAddress struct {
...
func NewDomesticShipmentResponseFromAddress() *DomesticShipmentResponseFromAddress {
	this := DomesticShipmentResponseFromAddress{}
	return &this
}
...
func (o DomesticShipmentResponseFromAddress) MarshalJSON() ([]byte, error) {
...
func (o DomesticShipmentResponseFromAddress) ToMap() (map[string]interface{}, error) {
...
type NullableDomesticShipmentResponseFromAddress struct {
	value *DomesticShipmentResponseFromAddress
	isSet bool
}

func (v NullableDomesticShipmentResponseFromAddress) Get() *DomesticShipmentResponseFromAddress {
	return v.value
}

func (v *NullableDomesticShipmentResponseFromAddress) Set(val *DomesticShipmentResponseFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableDomesticShipmentResponseFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableDomesticShipmentResponseFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomesticShipmentResponseFromAddress(val *DomesticShipmentResponseFromAddress) *NullableDomesticShipmentResponseFromAddress {
	return &NullableDomesticShipmentResponseFromAddress{value: val, isSet: true}
}

func (v NullableDomesticShipmentResponseFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomesticShipmentResponseFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

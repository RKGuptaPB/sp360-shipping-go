...
// checks if the ReprintShipmentToAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReprintShipmentToAddress{}

// ReprintShipmentToAddress struct for ReprintShipmentToAddress
type ReprintShipmentToAddress struct {
...
func (o ReprintShipmentToAddress) MarshalJSON() ([]byte, error) {
...
func (o ReprintShipmentToAddress) ToMap() (map[string]interface{}, error) {
...
type NullableReprintShipmentToAddress struct {
	value *ReprintShipmentToAddress
	isSet bool
}

func (v NullableReprintShipmentToAddress) Get() *ReprintShipmentToAddress {
	return v.value
}

func (v *NullableReprintShipmentToAddress) Set(val *ReprintShipmentToAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableReprintShipmentToAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableReprintShipmentToAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReprintShipmentToAddress(val *ReprintShipmentToAddress) *NullableReprintShipmentToAddress {
	return &NullableReprintShipmentToAddress{value: val, isSet: true}
}

func (v NullableReprintShipmentToAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReprintShipmentToAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true

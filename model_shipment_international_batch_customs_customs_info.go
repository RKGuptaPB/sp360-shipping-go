...
// checks if the ShipmentInternationalBatchCustomsCustomsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipmentInternationalBatchCustomsCustomsInfo{}

// ShipmentInternationalBatchCustomsCustomsInfo This is additional customs information required along with item details.
type ShipmentInternationalBatchCustomsCustomsInfo struct {
...
type _ShipmentInternationalBatchCustomsCustomsInfo ShipmentInternationalBatchCustomsCustomsInfo
...
func NewShipmentInternationalBatchCustomsCustomsInfo(reasonForExport string, customsDeclaredValue float32, currencyCode string) *ShipmentInternationalBatchCustomsCustomsInfo {
	this := ShipmentInternationalBatchCustomsCustomsInfo{}
...
func (o ShipmentInternationalBatchCustomsCustomsInfo) MarshalJSON() ([]byte, error) {
...
func (o ShipmentInternationalBatchCustomsCustomsInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ShipmentInternationalBatchCustomsCustomsInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varShipmentInternationalBatchCustomsCustomsInfo := _ShipmentInternationalBatchCustomsCustomsInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varShipmentInternationalBatchCustomsCustomsInfo)

	if err != nil {
		return err
	}

	*o = ShipmentInternationalBatchCustomsCustomsInfo(varShipmentInternationalBatchCustomsCustomsInfo)

	return err
}

type NullableShipmentInternationalBatchCustomsCustomsInfo struct {
	value *ShipmentInternationalBatchCustomsCustomsInfo
	isSet bool
}

func (v NullableShipmentInternationalBatchCustomsCustomsInfo) Get() *ShipmentInternationalBatchCustomsCustomsInfo {
	return v.value
}

func (v *NullableShipmentInternationalBatchCustomsCustomsInfo) Set(val *ShipmentInternationalBatchCustomsCustomsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableShipmentInternationalBatchCustomsCustomsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableShipmentInternationalBatchCustomsCustomsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipmentInternationalBatchCustomsCustomsInfo(val *ShipmentInternationalBatchCustomsCustomsInfo) *NullableShipmentInternationalBatchCustomsCustomsInfo {
	return &NullableShipmentInternationalBatchCustomsCustomsInfo{value: val, isSet: true}
}

func (v NullableShipmentInternationalBatchCustomsCustomsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipmentInternationalBatchCustomsCustomsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
